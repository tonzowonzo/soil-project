...
joblib.dump(rand_for, 'random_forest_soil.pkl')

# Reload the model
joblib.load('random_forest_soil.pkl')
...
#x_new.columns = ['Topsoil Organic Carbon', 'Topsoil CEC',
#                 'Subsoil Organic Carbon', 'Subsoil CEC', 'Subsoil TEB']
#new_rand_for = RandomForestClassifier(max_features=None, n_estimators=5, bootstrap=False)
#from sklearn.model_selection import train_test_split
